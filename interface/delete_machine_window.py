...
################################################################################
## Form generated from reading UI file 'delete_machine_window.ui'
##
...
"QPushButton::hover {background-color : #ffc13b};")
        ...
        self.comboBox.setGeometry(QRect(40, 130, 391, 31))
        self.comboBox.setStyleSheet(u"background-color: white;\n"
"border: 1px solid #ff6e40;")
        self.label_4 = QLabel(self.frame)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(40, 90, 171, 20))
    ...
    def retranslateUi(self, DetailWindow):
        ...
        self.label_4.setText(QCoreApplication.translate("DetailWindow", u"Seleccionar maquina a eliminar:", None))
    # retranslateUi
