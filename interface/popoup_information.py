...
################################################################################
## Form generated from reading UI file 'popoup_information.ui'
##
...
class DetailWindow(object):
    def setupUi(self, DetailWindow):
        ...
        self.add_edit_button_3.setGeometry(QRect(60, 100, 201, 30))
...
"QPushButton::hover {background-color : #ffc13b};")
        ...
        self.label_3.setGeometry(QRect(40, 30, 261, 31))
    ...
    def retranslateUi(self, DetailWindow):
        ...
        self.title_label.setText(QCoreApplication.translate("DetailWindow", u"Informacion", None))
        self.minimize_button.setText("")
        self.restore_button.setText("")
        self.maximize_button.setText("")
        self.close_button.setText("")
        self.add_edit_button_3.setText(QCoreApplication.translate("DetailWindow", u"Aceptar", None))
        self.label_3.setText(QCoreApplication.translate("DetailWindow", u"Informacion a\u00f1adida correctamente", None))
    # retranslateUi
