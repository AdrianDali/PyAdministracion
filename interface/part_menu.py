...
################################################################################
## Form generated from reading UI file 'part_menu.ui'
##
...
"QPushButton::hover {background-color : #ffc13b};")
    ...
    def retranslateUi(self, DetailWindow):
        ...
        self.title_label.setText(QCoreApplication.translate("DetailWindow", u"Menu Piezas", None))
        self.minimize_button.setText("")
        self.restore_button.setText("")
        self.maximize_button.setText("")
        self.close_button.setText("")
        self.edit_button.setText(QCoreApplication.translate("DetailWindow", u"Editar Pieza", None))
        self.finish_button.setText(QCoreApplication.translate("DetailWindow", u"Eliminar Pieza", None))
        self.view_button.setText(QCoreApplication.translate("DetailWindow", u"Crear Pieza", None))
    # retranslateUi
