...
"QPushButton::hover {background-color : #ffc13b};")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.new_recipe_button.setText(QCoreApplication.translate("MainWindow", u"Usuarios", None))
        self.new_recipe_button_3.setText(QCoreApplication.translate("MainWindow", u"Maquinas", None))
        self.new_recipe_button_4.setText(QCoreApplication.translate("MainWindow", u"Piezas ", None))
        self.view_button.setText(QCoreApplication.translate("MainWindow", u"Historial Procesos", None))
        self.new_recipe_button_2.setText(QCoreApplication.translate("MainWindow", u"Graficas", None))
    # retranslateUi
