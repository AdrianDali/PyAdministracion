...
################################################################################
## Form generated from reading UI file 'edit_part_window.ui'
##
...
class DetailWindow(object):
    def setupUi(self, DetailWindow):
        ...
        self.label_2.setGeometry(QRect(50, 200, 111, 16))
...
"QPushButton::hover {background-color : #ffc13b};")
        ...
        self.comboBox.setGeometry(QRect(50, 40, 391, 31))
        self.comboBox.setStyleSheet(u"background-color: white;\n"
"border: 1px solid #ff6e40;")
        self.label_4 = QLabel(self.frame)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(50, 0, 171, 20))
        self.administrador_line_edit_2 = QLineEdit(self.frame)
        self.administrador_line_edit_2.setObjectName(u"administrador_line_edit_2")
        self.administrador_line_edit_2.setGeometry(QRect(50, 240, 91, 30))
        self.administrador_line_edit_2.setStyleSheet(u"background-color: white;\n"
"border: 1px solid #ff6e40;")
        self.label_5 = QLabel(self.frame)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setGeometry(QRect(150, 250, 111, 16))
    ...
    def retranslateUi(self, DetailWindow):
        ...
        self.title_label.setText(QCoreApplication.translate("DetailWindow", u"Pieza", None))
        self.minimize_button.setText("")
        self.restore_button.setText("")
        self.maximize_button.setText("")
        self.close_button.setText("")
        self.label_2.setText(QCoreApplication.translate("DetailWindow", u"Peso Merma (gr):", None))
        ...
        self.label_4.setText(QCoreApplication.translate("DetailWindow", u"Seleccionar pieza a editar", None))
        self.label_5.setText(QCoreApplication.translate("DetailWindow", u"gr", None))
    # retranslateUi
