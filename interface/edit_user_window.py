...
"QPushButton::hover {background-color : #ffc13b};")
        ...
        self.dateEdit.setGeometry(QRect(50, 240, 291, 31))
...
"border: 1px solid #ff6e40;")
    ...
    def retranslateUi(self, DetailWindow):
        ...
        self.title_label.setText(QCoreApplication.translate("DetailWindow", u"Usuario/Operario", None))
        self.minimize_button.setText("")
        self.restore_button.setText("")
        self.maximize_button.setText("")
        self.close_button.setText("")
        self.label_2.setText(QCoreApplication.translate("DetailWindow", u"Fecha Nacimiento:", None))
        self.add_edit_button_3.setText(QCoreApplication.translate("DetailWindow", u"Editar", None))
        self.label_3.setText(QCoreApplication.translate("DetailWindow", u"Nombre Usuario:", None))
        self.cancel_button.setText(QCoreApplication.translate("DetailWindow", u"Cancelar", None))
        self.dateEdit.setDisplayFormat(QCoreApplication.translate("DetailWindow", u"d/M/yyyy", None))
        self.label_4.setText(QCoreApplication.translate("DetailWindow", u"Seleccionar usuario a editar:", None))
    # retranslateUi
