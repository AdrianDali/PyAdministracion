...
"QPushButton::hover {background-color : #ffc13b};")
    ...
    def retranslateUi(self, DetailWindow):
        ...
        self.title_label.setText(QCoreApplication.translate("DetailWindow", u"Menu Usuarios/Operario", None))
        self.minimize_button.setText("")
        self.restore_button.setText("")
        self.maximize_button.setText("")
        self.close_button.setText("")
        self.edit_button.setText(QCoreApplication.translate("DetailWindow", u"Editar Usuario", None))
        self.finish_button.setText(QCoreApplication.translate("DetailWindow", u"Eliminar Usuario", None))
        self.view_button.setText(QCoreApplication.translate("DetailWindow", u"Crear Usuario", None))
    # retranslateUi
